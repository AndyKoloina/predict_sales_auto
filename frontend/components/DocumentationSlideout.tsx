...
/**
 * Propriétés du composant DocumentationSlideout
 */
interface DocumentationSlideoutProps {
  isOpen: boolean;
  onClose: () => void;
}
...
/**
 * Composant DocumentationSlideout
 * Panneau latéral coulissant contenant la documentation du projet
 */
      ...
      >
        ...
        <section className="mb-10">
          ...
          <p className="text-slate-400 leading-relaxed">
            Ce modèle a été entraîné sur un jeu de données de voitures d'occasion 
            provenant de Kaggle. Il contient des milliers d'annonces avec des 
            informations détaillées.
          </p>
          
          <ul className="list-disc list-inside mt-4 text-slate-300 space-y-2">
            <li>Marque et modèle du véhicule (<code>make</code>, <code>model</code>)</li>
            <li>Année de mise en circulation (<code>year</code>)</li>
            <li>Kilométrage (<code>mileage</code>)</li>
            <li>Type de carburant (<code>fuel_type</code>)</li>
            <li>Puissance du moteur (<code>engine_hp</code>)</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <div className="flex items-center gap-4 mt-4">
            <div className="w-16 h-16 bg-slate-700 rounded-full flex items-center justify-center">
              <span className="text-cyan-400 font-bold text-lg">AN</span>
            </div>
            <div>
          ...
          <div className="flex items-center gap-4 mt-4">
            <div className="w-16 h-16 bg-slate-700 rounded-full flex items-center justify-center">
              <span className="text-cyan-400 font-bold text-lg">MI</span>
            </div>
            <div>
              <h4 className="font-bold text-slate-200">
