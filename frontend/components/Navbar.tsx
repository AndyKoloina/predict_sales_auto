...
/**
 * Icône de voiture pour le logo
 */
const CarLogoIcon = () => (
  <svg 
    className="h-8 w-8 text-white group-hover:text-cyan-400 transition-colors duration-300" 
    viewBox="0 0 24 24" 
    fill="none" 
    stroke="currentColor" 
    strokeWidth="2" 
    ...
    <nav className="bg-slate-900/70 backdrop-blur-lg sticky top-0 z-50 border-b border-slate-700/50">
      <div className="container mx-auto px-6 py-3 flex justify-between items-center">
        ...
        <div className="flex items-center space-x-2">
          <Link 
            href="/predict" 
            className="px-4 py-2 rounded-md text-slate-300 hover:bg-slate-800 hover:text-cyan-400 transition-all duration-300 font-semibold"
          >
            Prédire
          </Link>
